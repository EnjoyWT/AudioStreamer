...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        /// Download
        let url = URL(string: "https://shaue-test.oss-cn-shanghai.aliyuncs.com/audio/2024-03-07/50e5b008090941ec9f6e896bbe9e7f06.mp3")!
        streamer.url = url
    }
    ...
    @IBAction func togglePlayback(_ sender: UIButton) {
        ...
        if streamer.state == .playing {
            streamer.pause()
//            let url = URL(string: "https://shaue-test.oss-cn-shanghai.aliyuncs.com/audio/2024-03-07/7d72664660d64f4cb446e40fe4abb48a.mp3")!
//
//            streamer.url = url
//            streamer.play()
